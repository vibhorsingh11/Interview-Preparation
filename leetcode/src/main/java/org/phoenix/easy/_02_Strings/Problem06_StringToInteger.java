...
* Read in next the characters until the next non-digit charcter or the end of the input is reached. The rest of the string
* is ignored.
...
* in the range. Specifically, integers less than -231 should be clamped to -231, and integers greater than 231 - 1 should
* be clamped to 231 - 1.
...
public class Problem06_StringToInteger {
